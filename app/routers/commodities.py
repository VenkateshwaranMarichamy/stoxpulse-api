...
@router.get("/profiles", response_model=PaginatedResponse[CommodityProfileSchema],
...
@router.get("/profiles/{profile_id}", response_model=CommodityProfileSchema,
...
@router.get("/trade-summary", response_model=PaginatedResponse[TradeSummarySchema],
...
@router.get("/latest-news", response_model=PaginatedResponse[LatestNewsSchema],
...
@router.get("/high-impact-news", response_model=PaginatedResponse[HighImpactNewsSchema],
